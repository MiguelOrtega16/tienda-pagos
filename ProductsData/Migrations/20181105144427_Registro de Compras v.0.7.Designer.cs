...
namespace TiendaData.Migrations
{
    ...
    [Migration("20181105144427_Registro de Compras v.0.7")]
    partial class RegistrodeComprasv07
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TiendaData.Models.CategoriaProducto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TiendaData.Models.Productos", b =>
                {
                    b.HasOne("TiendaData.Models.CategoriaProducto", "CategoriaProducto")
                        .WithMany()
